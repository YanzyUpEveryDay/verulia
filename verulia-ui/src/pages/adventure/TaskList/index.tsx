...
import type { AdvTask, AdvTaskQuery, AdvTaskForm } from '@/api/advTask'
      ...
      <Card>
        ...
        <Form form={form} layout="inline" className={styles.searchForm}>
          ...
          <Form.Item name="category" label="分类">
            <Select placeholder="请选择分类" style={{ width: 180 }} allowClear options={categoryOptions} />
          </Form.Item>
          <Form.Item name="difficulty" label="难度">
            <Select placeholder="请选择难度" style={{ width: 180 }} allowClear options={difficultyOptions} />
          </Form.Item>
          <Form.Item name="status" label="状态">
            <Select placeholder="请选择状态" style={{ width: 180 }} allowClear options={statusOptions} />
          </Form.Item>
          <Form.Item>
            <Space>
